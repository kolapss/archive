    ...
    <div class=" content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Добавить категорию</h4>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post">
                                <div class="form-group">
                                    <label>Имя категории<span style="color:red;">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="status" id="status" value="1" checked="checked">Активна
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="status" id="status" value="0">Неактивна
                                        </label>
                                    </div>

                                </div>
                                <button type="submit" name="create" class="btn btn-info">Добавить </button>
