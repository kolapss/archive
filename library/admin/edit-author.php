...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query->execute();
        $_SESSION['updatemsg'] = "Информация об авторе успешно обновлена";
    ...
    <div class=" content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Изменить информацию об авторе</h4>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post">
                                <div class="form-group">
                                    <label>Имя автора<span style="color:red;">*</span></label>
                                    <?php
                                    $athrid = intval($_GET['athrid']);
